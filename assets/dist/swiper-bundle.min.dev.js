...
var Swiper = function () {
      ...
      value: function slidesPerViewDynamic(e, t) {
        ...
        if (s.centeredSlides) {
          ...
          for (var _s14 = l + 1; _s14 < a.length; _s14 += 1) {
            a[_s14] && !_e37 && (_t24 += Math.ceil(a[_s14].swiperSlideSize), o += 1, _t24 > n && (_e37 = !0));
          }
  ...
  var ge = [function (e) {
    ...
    function c(e, t) {
      ...
      for (var _t33 = I; _t33 < z; _t33 += 1) {
        if (_t33 >= x && _t33 <= S) {
          var _s19 = L(_t33);

          void 0 === m || e ? P.push(_s19) : (_t33 > m && P.push(_s19), _t33 < u && C.push(_s19));
        }
      }
      ...
      if (P.forEach(function (e) {
        ...
        var _t34 = C[_e46];
        s.slidesEl.prepend(d(h[_t34], _t34));
    ...
    function T(e) {
      ...
      if (l = !1, o = !1, u.push(e), !(u.length < 2)) {
        ...
        if (m.imageEl) {
          ...
          m.originX = _e58, m.originY = _t42, m.imageEl.style.transitionDuration = "0ms";
        }
            ...
            if (r.freeMode.momentum) {
              if (c.velocities.length > 1) {
                var _e67 = c.velocities.pop(),
                    ...
                    _a31 = _e67.position - _s35.position,
              ...
              if (_f2 && i("transitionEnd", function () {
                ...
                if (_e66 = l ? Math.abs((-_p4 - t.translate) / t.velocity) : Math.abs((_p4 - t.translate) / t.velocity), r.freeMode.sticky) {
                  ...
                  _e66 = _s36 < _a32 ? r.speed : _s36 < 2 * _a32 ? 1.5 * r.speed : 2.5 * r.speed;
                }
      ...
      updateWrapperSize: function updateWrapperSize(e, s) {
        ...
        if (r.virtualSize = (e + n) * t, r.virtualSize = Math.ceil(r.virtualSize / l) - n, r.params.cssMode || (r.wrapperEl.style[r.getDirectionLabel("width")] = "".concat(r.virtualSize + n, "px")), a) {
          ...
          for (var _t45 = 0; _t45 < s.length; _t45 += 1) {
            var _a34 = s[_t45];
            i && (_a34 = Math.floor(_a34)), s[_t45] < r.virtualSize + s[0] && _e69.push(_a34);
          }
    ...
    ue({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e71 = 0; _e71 < a.length; _e71 += 1) {
          var _t46 = a[_e71];
          var _s39 = _e71;
          m && (_s39 = parseInt(_t46.getAttribute("data-swiper-slide-index"), 10));
          ...
          var _d4 = Math.max(Math.min(_t46.progress, 1), -1);
          ...
          _d4 <= 1 && _d4 > -1 && (f = 90 * _s39 + 90 * _d4, l && (f = 90 * -_s39 - 90 * _d4)), _t46.style.transform = _w, p.slideShadows && i(_t46, _d4, u);
        }
        ...
        if (s.style.transformOrigin = "50% 50% -".concat(o / 2, "px"), s.style["-webkit-transform-origin"] = "50% 50% -".concat(o / 2, "px"), p.shadow) if (u) h.style.transform = "translate3d(0px, ".concat(r / 2 + p.shadowOffset, "px, ").concat(-r / 2, "px) rotateX(89.99deg) rotateZ(0deg) scale(").concat(p.shadowScale, ")");else {
          var _e72 = Math.abs(f) - 90 * Math.floor(Math.abs(f) / 90),
              _t47 = 1.5 - (Math.sin(2 * _e72 * Math.PI / 360) / 2 + Math.cos(2 * _e72 * Math.PI / 360) / 2),
              _s40 = p.shadowScale,
              _a36 = p.shadowScale / _t47,
              _i19 = p.shadowOffset;
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e73 = 0, _t49 = a.length; _e73 < _t49; _e73 += 1) {
          var _t50 = a[_e73],
              _s41 = i[_e73],
          ...
          if (me(0, _t50).style.transform = _y, _t50.style.zIndex = 1 - Math.abs(Math.round(_u5)), r.slideShadows) {
            var _e74 = n ? _t50.querySelector(".swiper-slide-shadow-left") : _t50.querySelector(".swiper-slide-shadow-top"),
                _s42 = n ? _t50.querySelector(".swiper-slide-shadow-right") : _t50.querySelector(".swiper-slide-shadow-bottom");

            _e74 || (_e74 = fe("coverflow", _t50, n ? "left" : "top")), _s42 || (_s42 = fe("coverflow", _t50, n ? "right" : "bottom")), _e74 && (_e74.style.opacity = _u5 > 0 ? _u5 : 0), _s42 && (_s42.style.opacity = -_u5 > 0 ? -_u5 : 0);
          }
        }
      },
      setTransition: function setTransition(e) {
        ...
        var _loop2 = function _loop2(_s43) {
          ...
          if (f && g.shadow || !f) {
            ...
            if (!_e76 && g.shadow && (_e76 = fe("creative", a)), _e76) {
              var _t51 = r.shadowPerProgress ? c * (1 / r.limitProgress) : c;

              _e76.style.opacity = Math.min(Math.max(Math.abs(_t51), 0), 1);
            }
          }
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _o9 = 0; _o9 < e.length; _o9 += 1) {
          ...
          if (i.slideShadows) {
            ...
            _e79 || (_e79 = fe("cards", _d6)), _e79 && (_e79.style.opacity = Math.min(Math.max((Math.abs(_p6) - .5) / .5, 0), 1));
          }
